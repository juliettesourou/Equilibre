...
const projects = [
  {
    ...
    desc:
      "Mise en relation de plateformes, d'outils et de services numériques pour fluidifier les échanges de données et simplifier les opérations.",
    image: apiImage,
    tags: ['API', 'Intégration', 'Interopérabilité'],
  },
  {
    id: 2,
    title: "Développement d'applications web et mobiles sur mesure",
    desc:
      "Conception de solutions web et mobiles adaptées aux besoins métiers des clients, avec une approche moderne, évolutive et centrée sur l'usage.",
    image: devImage,
  ...
  },
  {
    ...
    desc:
      "Automatisation de tâches répétitives et de flux de travail pour faire gagner du temps aux équipes et rendre les processus plus fiables.",
    image: codeImage,
  ...
  },
  {
    ...
    desc:
      "Mise en place d'actions digitales pour renforcer la présence en ligne, soutenir la notoriété et développer l'attractivité de la marque.",
    image: numeriqueImage,
    tags: ['Visibilité', 'Marketing', 'Présence en ligne'],
  },
]
...
const Projects = () => {
  ...
  return (
    <section>
      <Title
        title="Des réalisations qui reflètent notre savoir-faire"
        eyebrow='Nos réalisations'
        subtitle="Equilibre met en avant les domaines dans lesquels l'entreprise intervient concrètement : intégration d'API, développement sur mesure, automatisation et visibilité numérique."
      />
      ...
      <div className='mt-12 rounded-[1.9rem] bg-[linear-gradient(90deg,#0E53B7_0%,#1765D4_70%,#E50012_100%)] px-5 py-6 shadow-[0_24px_55px_-36px_rgba(14,83,183,0.35)] md:flex md:items-center md:justify-between md:px-8'>
        <div>
          <p className='text-xl font-semibold text-white'>Prêt à donner un nouvel élan à votre activité ?</p>
