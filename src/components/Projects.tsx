          ...
          >
            <div className={project.id === 3 ? 'grid md:grid-cols-[0.92fr_1.08fr] md:items-stretch' : ''}>
              ...
              <div className='p-5'>
                ...
                <p className='mt-3 inline-flex rounded-full border border-[#CFE6DC] bg-[#E6F5EF] px-4 py-2 text-[0.82rem] font-semibold leading-6 text-[#0E6B54] shadow-[0_14px_30px_-24px_rgba(14,107,84,0.45)]'>
                  DOI : {project.doi}
                </p>
        ...
        <div className='grid gap-4' ref={gridRef}>
          {collaborations.map((item, i) => (
            <article
              ...
              className={`glass-card elegant-card rounded-[1.45rem] border border-[#E1E9E5] bg-[linear-gradient(180deg,#ffffff_0%,#fbfefd_100%)] p-6 shadow-[0_18px_40px_-34px_rgba(12,80,61,0.35)] ${gridInView ? 'anim-fade-up' : 'opacity-0'}`}
            >
              <div className='flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between'>
                ...
                <p className='inline-flex rounded-full border border-[#CFE6DC] bg-[#E6F5EF] px-4 py-2 text-[0.82rem] font-semibold leading-6 text-[#0E6B54] shadow-[0_14px_30px_-24px_rgba(14,107,84,0.45)]'>
                  DOI : {item.doi}
                </p>
              </div>
            </article>
